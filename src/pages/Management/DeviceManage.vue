  ...
  <div class="notification-page">
          ...
          <el-row :gutter="15" v-if="!isOA">
            <el-col :span="400">
              ...
              >
                ...
                >
                  <el-option
                    v-for="option in orgnizationOptions"
                    :key="option.orgnization.id"
                    :label="option.orgnization.name"
                    :value="option.orgnization.id"
                  ></el-option>
                </el-select>
              </el-form-item>
            </el-col>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" v-show="active != 0" @click="previous"
          >上一步</el-button
        >
        <el-button type="primary" v-show="active != 3" @click="next"
          >下一步</el-button
        >
        <el-button type="primary" v-show="active == 3" @click="addsfinish"
          >完成</el-button
        >
      </span>
    </el-dialog>
    ...
    <div style="margin-left:120px">
     <p>联系电话<br/><strong> {{ mockDevice.maintenancePhone }}</strong></p>
          ...
          <div class="detail-buttons " style="text-align: center">
            <el-button @click="userecord(mockDevice)" type="primary"
              >使用记录</el-button
            >
            <el-button @click="mianrecord(mockDevice)" type="primary"
              >维保记录</el-button
            >
            <el-button @click="removeDevice(mockDevice)" type="danger"
              >移除设备</el-button
            >
          </div>
        </template>
          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-form-item>
                ...
                <el-button v-if="!isHW" type="primary" @click="adddevice"
                  >添加设备</el-button
                >
                <el-button v-if="!isHW" type="primary" @click="batchadd"
                  >批量添加</el-button
                >
              </el-form-item>
            </el-col>
...
.home_page {
  ...
  .with-border {
    ...
    margin-bottom: 10px; /* 可根据需要调整盒子之间的垂直间距 */
  }
  .deviceImg {
    width: 180px;
    height: 150px;
